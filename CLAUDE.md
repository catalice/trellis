...
- **Design for the actual brain.** Anchors not schedules, dials not switches, experiments not streaks, one-action protocols, they-are-the-study — at runtime these are the user's preference rows, not constitution text (moved 20 Sep 2026: they describe a person, and the person lives in the brain); every feature must be designed so those laws are followable.
